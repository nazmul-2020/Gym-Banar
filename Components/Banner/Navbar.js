...
const Navbar = () => {
    return (
        <div className={`${styles.nav_bg} ${'mt'}`}>

            <div class=" mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
                <div class="relative flex items-center justify-between">
                    <p>
                        <span className={`${styles.gym} ${"text-xl text-white "}`}>Gym</span>
                        <span className={`${styles.baran} ${"text-xl"}`}
                        >baran</span>
                    </p>

                    <ul class="flex items-center space-x-8 font lg:flex">

                        <Link href="/" className="font-normal text-black">Home</Link>
